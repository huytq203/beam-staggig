...
export const InputNumberByType = forwardRef<any, InputNumberByTypeProps>(
  (props, ref) => {
    ...
    return <InputNumber ref={ref} {...elementProps} {...rest} />;
  }
);
InputNumberByType.displayName = 'InputNumberByType';
