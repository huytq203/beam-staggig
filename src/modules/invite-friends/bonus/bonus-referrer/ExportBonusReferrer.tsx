...
export const ExportBonusReferrerButton = (props: any) => {
  const { data } = props;
  const onClickExportData = async () => {
    const downloadData: any = await FriendInvatationService.exportBounsInviter(
      data
    );
    return downloadData;
  };
  return (
    <DownloadLink
      ...
      filename={`Danh_sach_nguoi_gioi_thieu_dat_thuong_${DateTimeHelper.formatDateTime(
