...
import { PhoneCardFilter } from './PhoneCardFilter';
import { LuckyBoxService } from '@services/lucky-box';
import Table from 'rc-table';
export const PhoneCardList = (props: any) => {
  ...
  return (
    <ContentWrapper pageTitle="Danh sách chi thưởng">
      <div className="flex flex-col gap-5">
        {showFilter && (
          <PhoneCardFilter onFilter={setFilter} refetch={refetch} />
        )}
