...
import { ExportMissionCheckinButton } from './ExportMissionCheckin';
export const MissionCheckinFilter = (props: any) => {
    ...
    <>
      <form onSubmit={handleSubmit(onSubmitValues)}>
        <div className="grid grid-cols-2 gap-4">
          ...
          <ExportMissionCheckinButton filterExport={getValues()} />
        </div>
      </form>
    </>
  );
