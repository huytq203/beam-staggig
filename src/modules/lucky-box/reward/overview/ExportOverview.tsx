...
export const ExportOverViewButton = (props: any) => {
  const { filterExport } = props;

  const onClickExportData = async () => {
    const downloadData: any = await LuckyBoxService.exportReward(filterExport);
    return downloadData;
  };
    ...
    <>
      ...
      >
        <DownloadLink
          ...
          filename={`Danhsachnhanthuong_Tonghop_${DateTimeHelper.formatDateTime(
            new Date()
          )}.xlsx`}
